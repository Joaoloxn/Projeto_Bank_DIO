...
namespace Projeto_Bank
{
    class Program
    {
        ...
        {
            string opacaoUsuario = ObeterOpcaoUsuario();
            ...
            
            {
                ...
                opacaoUsuario = ObeterOpcaoUsuario();
            }
        ...
        private static void ListarContas()
        {
            ...
            for(int i = 0; i < listContas.Count; i++)
            {
                ...
                private static void Transferir()
                {
                    ...
                    listContas[indiceContaOrigem].Transferir(valorTranferencia, 
        ...
        private static void InserirConta()
        {
            ...
            Console.WriteLine("Digite 1 para conta e Física ou 2 para conta Jurídica: ");
            ...
            Console.WriteLine("Digite o crétido: ");
